...
package io.flamingock.examples.mongodb.springboot.springdata.client;

import io.flamingock.examples.mongodb.springboot.springdata.MongodbSpringbootSpringdata;
...
@Document(collection = MongodbSpringbootSpringdata.CLIENTS_COLLECTION_NAME)
@CompoundIndexes({
